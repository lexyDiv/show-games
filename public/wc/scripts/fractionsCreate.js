const fractionsCrate = function () {
  ...
  */
  ...
  freeLandObjects
    ...
    /*
  new LandObj(1,10,25,10000000),
  new LandObj(1,130,35,10000000),
  new LandObj(1,240,25,10000000),
  new LandObj(1,10,200,10000000),
  
  new LandObj(1,130,200,10000000),
  new LandObj(1,245,200,10000000),
  //*/

    //new LandObj(1,10,10,50000)//,new LandObj(1,10,50,50000),

    /*
  new LandObj("oil",30,70,50000),
  new LandObj("oil",120,70,50000),
  new LandObj("oil",30,60,50000),
  new LandObj("oil",120,60,50000),
  new LandObj("oil",70,60,50000),
  //*/

    //new LandObj("oil",20,75,50000),
    //new LandObj("oil",100,75,50000),
    //new LandObj("oil",170,75,50000),
    //new LandObj("oil",70,80,50000),
    //i>100&&i<180

    //new LandObj("oil",30,35,100000),
    //new LandObj("oil",48,35,100000),
    ();
  ...
  for (let i = 0; i < fractions.length; i++) {
    ...
    for (let k = 0; k < fractions[i].peoples.length; k++) {
      ...
      let unit = fractions[i].peoples[k];
