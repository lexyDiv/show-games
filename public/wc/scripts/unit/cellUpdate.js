...
Unit.prototype.cellUpdate = function () {
  ...
  if (!this.fly && !this.sweeme) {
    ...
    for (let k = 0; k < this.contaktCells.length; k++) {
      ...
      if (cellData.iContaktWith.indexOf(this.contaktCells[k]) !== -1) {
      ...
      for (let k = 0; k < this.cell.cellsForUnitCellUpdate.length; k++) {
        ...
        if (
          ...
          if (
            ...
            if (
              cell.unit.fatherFraction.activeBuildings.indexOf(cell.unit) === -1
            ) {
    ...
    for (let k = 0; k < this.cell.cellsForUnitCellUpdate.length; k++) {
      ...
      if (
        ...
        if (cell.dragoon.animys.indexOf(this.cell.dragoon) === -1) {
  ...
  */
          ...
          if (cell.unit.unitStatus === 'life') {
            ...
            if (cell.unit.animys.indexOf(this.cell.dragoon) === -1) {
