...
const unit_dop_menu_control = function () {
  ...
  */
        ...
        if (cell.name === 'hold_stop groop') {
          ...
          menu_unit_for_update.myJoubeTimer = menu_unit_for_update.fatherFraction.myJoubeTimer_fou;
          menu_unit_for_update.fatherFraction.myJoube_face_animY_fou = cell.face_animY; ///  !!!!!!!!!!!!!
          ...
          menu_unit_for_update.myJoubeTimer = menu_unit_for_update.fatherFraction.myJoubeTimer_kuz;
          menu_unit_for_update.fatherFraction.myJoube_face_animY_kuz = cell.face_animY; ///  !!!!!!!!!!!!!
          ...
          menu_unit_for_update.myJoubeTimer = menu_unit_for_update.fatherFraction.myJoubeTimer_leso;
          menu_unit_for_update.fatherFraction.myJoube_face_animY_leso = cell.face_animY; ///  !!!!!!!!!!!!!

          menu_unit_for_update.fatherFraction.gold -= cell.gold;
          menu_unit_for_update.fatherFraction.wood -= cell.wood;
          menu_unit_for_update.fatherFraction.oil -= cell.oil;
        } else if (cell.name === 'dopFlyAttack_level') {
          menu_unit_for_update.fatherFraction.myJoube_leso = 'dopFlyAttack_level';
          menu_unit_for_update.fatherFraction.myJoubeTimer_leso = myJoube_time(
            menu_unit_for_update.fatherFraction.myJoube_leso,
          );
          ...
          const obj = getMinDistanse(menu_unit_for_update, target);
          ...
          let target = allContinents[menu_unit_for_update.cell.continent].shahts;
          ...
          const vertikal = Math.floor(obj.y / 50);
          const horizont = Math.floor(obj.x / 50);
